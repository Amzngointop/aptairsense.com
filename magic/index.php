...
define('CAMPAIGN_ID', "c3ba7e2fdef4609beaaea30201ce61ff");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'f1c1a67892ff80b145b24ef50e19d2c6');
define('MP_PARAM_NAME', '__pl_sess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'cff9b8017283779a24969714c16446e0');
define('CHECK_MCPROXY_VALUE', 'cd9b47c1160380649e09e750eafc607de7758dbb225c8ee7a4699a400c97a4d6');
